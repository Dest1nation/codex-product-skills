...
| --- | --- | --- |
| Direction-changing | Changes requirement goal, core user, core scenario, or main boundary | Do not hand off; return to Discovery Conversation |
...
- Direction-changing gaps must be resolved before Handoff IR is finalized.
